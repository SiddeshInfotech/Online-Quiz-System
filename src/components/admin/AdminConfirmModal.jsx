          ...
          >
            ...
            <div className="mt-6 flex items-center justify-end gap-3 pt-4 border-t border-slate-800/80">
              ...
              <button
                ...
                onClick={onConfirm}
                disabled={isLoading}
                className={`px-4 py-2 text-sm font-semibold rounded-xl transition-colors shadow-lg flex items-center gap-2 disabled:opacity-50 ${variantStyles[variant] || variantStyles.danger
                  }`}
              >
                {isLoading && (
