  ...
  return (
    <Card className="p-6 relative overflow-hidden animate-pulse flex flex-col gap-4">
      ...
      <div className="flex gap-4 items-start">
        <div className="w-16 h-16 rounded-2xl surface-subtle shrink-0" />
        <div className="flex-1 flex flex-col gap-2 pt-1">
          <div className="h-5 w-3/4 surface-subtle rounded-lg" />
      ...
      {/* Progress Bar area */}
      <div className="mt-auto pt-4 border-t border-app flex flex-col gap-2">
        <div className="flex justify-between">
          <div className="h-3 w-1/4 surface-elev rounded-lg" />
          <div className="h-3 w-1/4 surface-elev rounded-lg" />
        </div>
        <div className="h-2 w-full surface-subtle rounded-full" />
      </div>
    </Card>
  );
};
