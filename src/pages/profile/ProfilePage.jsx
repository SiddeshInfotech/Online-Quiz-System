  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative w-full max-w-[640px] surface rounded-3xl shadow-2xl border border-app flex flex-col z-10 max-h-[90vh] overflow-hidden"
      >
        {/* Header */}
        <div className="flex items-center justify-between p-6 pb-4 border-b border-app flex-shrink-0">
          <div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-4">
            ...
            <div className="flex flex-col items-center gap-2 pb-2">
              ...
              <p className="text-xs text-app-muted font-medium">Profile Picture</p>
            </div>
            ...
            <div className="border-t border-app pt-4 mt-1">
              <p className="text-sm font-bold text-app mb-3 flex items-center gap-2">
              ...
              {/* Subject Interests - Direct Interactive Subject Chips */}
              <div className="flex flex-col gap-2 pt-1">
                <div className="flex items-center justify-between">
                  ...
                  {subjectInterests.length > 0 && (
                    <span className="text-[11px] font-bold text-violet-600 dark:text-violet-400 bg-violet-50 dark:bg-violet-950/50 px-2.5 py-0.5 rounded-md border border-violet-200 dark:border-violet-800">
                      {subjectInterests.length} Selected
                    </span>
                  )}
                </div>

                {/* Direct Subject Chips */}
                <div className="flex flex-wrap gap-2 pt-1">
                  {[
                    "C", "C++", "Python", "Java", "JavaScript", "TypeScript",
                    "React", "Node.js", "Django", "Flask", "Rust"
                  ].map((tech) => {
                    const isSelected = subjectInterests.includes(tech);
                    return (
                      <button
                        key={tech}
                        type="button"
                        ...
                        className={`text-xs px-3 py-1.5 rounded-xl border transition-all cursor-pointer flex items-center gap-1.5 ${
                          isSelected
                            ? "bg-violet-600 text-white border-violet-600 font-bold shadow-md shadow-violet-600/30 ring-2 ring-violet-400/30"
                            : "surface-subtle text-app hover:text-violet-600 border-app hover:border-violet-500/50 font-medium"
                        }`}
                      >
                        {isSelected ? "✓ " : "+ "}
                        {tech}
          ...
          {/* Actions Footer */}
          <div className="p-6 pt-4 border-t border-app flex-shrink-0 flex flex-col gap-3 surface-subtle">
            {fieldError && (
...
const ProfilePage = () => {
  ...
  // Auto-open edit modal if navigated with ?edit=true or state.openEdit
  useEffect(() => {
    const params = new URLSearchParams(location.search);
    if (params.get("edit") === "true" || location.state?.openEdit) {
      setShowModal(true);
    }
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            >
              <Card className="p-6 hover:shadow-xl transition-shadow duration-300">
                <div className="flex items-center gap-3 mb-5 pb-3 border-b border-app">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                  ...
                  <div className="flex items-center gap-3 py-3 px-4 rounded-xl surface-subtle border border-app hover:bg-[var(--bg-surface)] hover:shadow-sm transition-all duration-300">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-base font-semibold text-app truncate">
            ...
            >
              <Card className="p-6 hover:shadow-xl transition-shadow duration-300">
                <div className="flex items-center justify-between mb-5 pb-3 border-b border-app">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                    ...
                    <div className="flex items-center gap-3 py-3 px-4 rounded-xl surface-subtle border border-app hover:bg-[var(--bg-surface)] hover:shadow-sm transition-all duration-300">
                      ...
                      <div>
                        ...
                        <p className="text-base font-semibold text-app mt-0.5">
